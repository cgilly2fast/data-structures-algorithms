...
public class FindPaths {
	public static void main(String[] args) {
		...
		Collection<Vertex> adjV = g.adjacentVertices( ATL );
		System.out.println(adjV);
		
		int cost = g.edgeCost(ATL, IND);
		...
		while(true) {
			...
			System.out.print("Shortest path from " + a.getLabel() + " to " + b.getLabel() + ": " );
			
			if( path == null ) {
				System.out.println( "does not exist" );
			} else {
				for( Vertex vert : path.vertices) {
